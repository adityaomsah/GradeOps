# grader.py
# Goal: Take extracted answer text + rubric, run through LangGraph pipeline
# Pipeline: plagiarism_check → (route) → grade_answer → generate_justification → END
# If plagiarism flagged: → human_review_needed → END
